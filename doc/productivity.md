...
```sh
cmake --build build --target bbcoind bbcoin-cli
cmake --build build --target bbcoin-qt
cmake --build build --target bench_bbcoin
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:bbcoin/bbcoin.git
```
