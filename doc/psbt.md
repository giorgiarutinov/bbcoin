...
[BIP 174](https://github.com/bbcoin/bips/blob/master/bip-0174.mediawiki)).
...
the command line in case `bbcoin-cli` is used.
...
Later, when *V* BBCO has been received on *Amulti*, and Bob and Carol want to
