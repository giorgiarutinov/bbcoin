...
Assumeutxo is a feature that allows fast bootstrapping of a validating bbcoind
instance.
...
```
$ bbcoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ bbcoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
