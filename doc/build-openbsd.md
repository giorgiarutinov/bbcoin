...
This guide describes how to build bbcoind, command-line utilities, and GUI on OpenBSD.
...
It is not necessary to build wallet functionality to run either `bbcoind` or `bbcoin-qt`.
...
...
to: /path/to/bbcoin/depends/*-unknown-openbsd*
```
...
(see issue [#6658](https://github.com/bbcoin/bbcoin/issues/6658)).
