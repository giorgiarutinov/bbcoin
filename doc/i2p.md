...
debug log about your I2P configuration and connections. Run `bbcoin-cli help
...
attacks](https://en.bbcoin.it/wiki/Weaknesses#Sybil_attack). You can use
`bbcoin-cli -addrinfo` to see the number of I2P addresses known to your node.
...
To see which I2P peers your node is connected to, use `bbcoin-cli -netinfo 4`
or the `getpeerinfo` RPC (e.g. `bbcoin-cli getpeerinfo`).

You can use the `getnodeaddresses` RPC to fetch a number of I2P peers known to your node; run `bbcoin-cli help getnodeaddresses` for details.
