Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://bbcoin.org/bin/bbcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update bbcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bbcoin-tx to create v2 transactions (btcdrak)
