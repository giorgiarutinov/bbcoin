Bitcoin Core version 28.0 is now available from:
  ...
  <https://bbcoincore.org/bin/bbcoin-core-28.0/>
...
```
cd /path/to/bbcoin-28.0/bin
xattr -d com.apple.quarantine bbcoin-cli bbcoin-qt bbcoin-tx bbcoin-util bbcoin-wallet bbcoind test_bbcoin
codesign -s - bbcoin-cli bbcoin-qt bbcoin-tx bbcoin-util bbcoin-wallet bbcoind test_bbcoin
```
...
Support for Testnet4 as specified in [BIP94](https://github.com/bbcoin/bips/blob/master/bip-0094.mediawiki)
...
See [JSON-RPC-interface.md](https://github.com/bbcoin/bbcoin/blob/master/doc/JSON-RPC-interface.md#json-rpc-11-vs-20) for details. (#27101)
...
libbbcoinconsensus Removal
---------------------------

The libbbcoin-consensus library was deprecated in 27.0 and is now completely removed. (#29648)
...
- Transactions with version number set to 3 are now treated as standard on all networks (#29496),
  ...
  described in [BIP 431](https://github.com/bbcoin/bips/blob/master/bip-0431.mediawiki).  The
...
- A new `-testdatadir` option has been added to `test_bbcoin` to allow specifying the
