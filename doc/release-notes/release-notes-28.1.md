Bitcoin Core version 28.1 is now available from:
  ...
  <https://bbcoincore.org/bin/bbcoin-core-28.1>
...
- When the `-port` configuration option is used, the default onion listening port will now
  ...
  127.0.0.1:5556`, or configure bbcoind with `-bind=127.0.0.1:8334=onion` to get the previous behavior.
  (#31223)
