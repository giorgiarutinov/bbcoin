...
Bitcoin Core version 23.0 is now available from:
  ...
  <https://bbcoincore.org/bin/bbcoin-core-23.0/>
...
- A bbcoind node will no longer rumour addresses to inbound peers by default.
...
- Full support has been added for the CJDNS network. See the new option `-cjdnsreachable` and [doc/cjdns.md](https://github.com/bbcoin/bbcoin/tree/23.x/doc/cjdns.md) (#23077)
...
[doc/tracing.md](https://github.com/bbcoin/bbcoin/blob/23.x/doc/tracing.md) and
usage examples are provided in [contrib/tracing/](https://github.com/bbcoin/bbcoin/tree/23.x/contrib/tracing).
...
- The top-level fee fields `fee`, `modifiedfee`, `ancestorfees` and `descendantfees`
  ...
  fields in the `fees` object are denominated in BBCO. (#22689)
