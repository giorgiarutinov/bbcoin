Download URL: https://sourceforge.net/projects/bbcoin/files/Bitcoin/bbcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BBCO fee schedule (users still pay 0.01 BBCO per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bbcoin00 - #bbcoin99
