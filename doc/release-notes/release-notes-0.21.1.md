...
Bitcoin Core version 0.21.1 is now available from:
  ...
  <https://bbcoincore.org/bin/bbcoin-core-0.21.1/>
...
fungibility of all bbcoins. Spenders will enjoy lower fees and the
...
FAQ](https://bbcoincore.org/en/2016/06/08/version-bits-miners-faq/) for
details.
...
- Technical specifications
  - [BIP340 Schnorr signatures for secp256k1](https://github.com/bbcoin/bips/blob/master/bip-0340.mediawiki) 
  - [BIP341 Taproot: SegWit version 1 spending rules](https://github.com/bbcoin/bips/blob/master/bip-0341.mediawiki)
  - [BIP342 Validation of Taproot scripts](https://github.com/bbcoin/bips/blob/master/bip-0342.mediawiki)

- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit Bitcoin](https://bbcoinmagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-bbcoin)
  - [What do Schnorr Signatures Mean for Bitcoin?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-bbcoin)
...
- Development history overview
  - [Taproot](https://bbcoinops.org/en/topics/taproot/)
  - [Schnorr signatures](https://bbcoinops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://bbcoinops.org/en/topics/tapscript/)
  - [Soft fork activation](https://bbcoinops.org/en/topics/soft-fork-activation/)

- Other
  - [Questions and answers related to taproot](https://bbcoin.stackexchange.com/questions/tagged/taproot)
...
- Due to [BIP 350](https://github.com/bbcoin/bips/blob/master/bip-0350.mediawiki)
  ...
  (e.g. through [BIP 341](https://github.com/bbcoin/bips/blob/master/bip-0341.mediawiki)).
...
### Documentation
- #21384 add signet to bbcoin.conf documentation (jonatack)
