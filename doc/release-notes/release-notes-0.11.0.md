Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://bbcoin.org/bin/bbcoin-core-0.11.0/>
...
defaults to 0.00001. This will cause transactions with fewer BBCO/kB fee to be
...
For example, add the following to `bbcoin.conf`:
...
related to the blockchain in the bbcoin system: the raw blocks as received over 
...
For an example script see [bbcoin-submittx](https://github.com/laanwj/bbcoin-submittx).
...
- #5334 `cf87536` libbbcoinconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new bbcoin-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add bbcoin logo to about screen
...
- #5809 `46bfbe7` Add bbcoin-cli man page
...
- #5849 `41259ca` contrib/init/bbcoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for bbcoin-tx)
