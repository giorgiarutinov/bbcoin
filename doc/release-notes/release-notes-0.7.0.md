Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/bbcoin/files/Bitcoin/bbcoin-0.7.0/

We recommend that everybody running prior versions of bbcoind/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/bbcoin/bbcoin/tarball/v0.7.0  # .tar.gz
  https://github.com/bbcoin/bbcoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the bbcoin-qt package:
  sudo apt-get install bbcoin-qt
...
Core bbcoin handling and blockchain database
...
* Ensure a changed bbcoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for bbcoin-qt.exe
* (Windows only): add meta-data to bbcoin-qt.exe (e.g. description)
...
* Bash programmable completion for bbcoind(1)
