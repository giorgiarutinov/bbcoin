...
complete --command bbcoind --no-files

# Extract options
function __fish_bbcoind_get_options
...
complete \
    --command bbcoind \
    --arguments "(__fish_bbcoind_get_options --nofiles)"
