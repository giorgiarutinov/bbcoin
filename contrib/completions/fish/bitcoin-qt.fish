...
complete --command bbcoin-qt --no-files

# Extract options
function __fish_bbcoinqt_get_options
...
complete \
    --command bbcoin-qt \
    --arguments "(__fish_bbcoinqt_get_options --nofiles)"
