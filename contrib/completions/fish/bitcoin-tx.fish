...
# Extract options
function __fish_bbcoin_tx_get_options
...
# Extract commands
function __fish_bbcoin_tx_get_commands
...
complete \
    --command bbcoin-tx \
    --condition "not __fish_bbcoin_seen_cmd (__fish_bbcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bbcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bbcoin-tx \
    --arguments "(__fish_bbcoin_tx_get_commands)" \
    --no-files
