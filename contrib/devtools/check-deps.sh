...
declare -A LIBS
LIBS[cli]="libbbcoin_cli.a"
LIBS[common]="libbbcoin_common.a"
LIBS[consensus]="libbbcoin_consensus.a"
LIBS[crypto]="crypto/libbbcoin_crypto.a"
LIBS[node]="libbbcoin_node.a"
LIBS[util]="util/libbbcoin_util.a"
LIBS[wallet]="wallet/libbbcoin_wallet.a"
...
# https://github.com/bbcoin/bbcoin/issues/10102
