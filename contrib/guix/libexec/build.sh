...
(
    ...
    case "$HOST" in
        *mingw*)
            ...
            mv build/bbcoin-win64-setup.exe "${OUTDIR}/${DISTNAME}-win64-setup-unsigned.exe"
            ;;
    esac
    ...
    (
        ...
        # copy over the example bbcoin.conf file. if contrib/devtools/gen-bbcoin-conf.sh
        # has not been run before buildling, this file will be a stub
        cp "${DISTSRC}/share/examples/bbcoin.conf" "${DISTNAME}/"
