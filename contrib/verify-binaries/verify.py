...
signature file SHA256SUMS.asc from bbcoincore.org and bbcoin.org and
compares them.
...
The builder keys are available in the guix.sigs repo:
    ...
    https://github.com/bbcoin-core/guix.sigs/tree/main/builder-keys
...
HOST1 = "https://bbcoincore.org"
HOST2 = "https://bbcoin.org"
VERSIONPREFIX = "bbcoin-core-"
...
def verify_published_handler(args: argparse.Namespace) -> ReturnCode:
    WORKINGDIR = Path(tempfile.gettempdir()) / f"bbcoin_verify_binaries.{args.version}"
    ...
    # remove binaries that are known not to be hosted by bbcoincore.org
...
def main():
    ...
    pub_parser.add_argument(
        'version', type=str, help=(
            f'version of the bbcoin release to download; of the format '
    ...
    pub_parser.add_argument(
        ...
        help=(
            ...
            '(Sometimes bbcoin.org lags behind bbcoincore.org.)')
    )
