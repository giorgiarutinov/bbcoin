...
of the [guix.sigs repository](https://github.com/bbcoin-core/guix.sigs/). When
...
builder-keys](https://github.com/bbcoin-core/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from https://bbcoincore.org and https://bbcoin.org.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/bbcoin-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/bbcoin-24.0.1-arm-linux-gnueabihf.tar.gz
```
