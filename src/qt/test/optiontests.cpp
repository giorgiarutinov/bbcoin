...
{
    // Test regression https://github.com/bbcoin/bbcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/bbcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/bbcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Bitcoin/Bitcoin-Qt.conf and all else left as default,
    // bbcoin-qt should set both -listen and -listenonion to false and start successfully.
