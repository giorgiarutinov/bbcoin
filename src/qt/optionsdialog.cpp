      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->bbcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bbcoinAtStartup);
    ...
    ui->bbcoinAtStartup->setToolTip(ui->bbcoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->bbcoinAtStartup->setText(ui->bbcoinAtStartup->text().arg(CLIENT_NAME));
...
{
    /* Main */
    mapper->addMapping(ui->bbcoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSBBCOontrols);
