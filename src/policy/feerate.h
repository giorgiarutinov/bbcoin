...
const std::string CURRENCY_UNIT = "BBCO"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    BBCO_KVB,      //!< Use BBCO/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::BBCO_KVB) const;
