 ...
 * for both bbcoind and bbcoin-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("Satoshi");


#include <bbcoin-build-info.h>
// The <bbcoin-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
#define GIT_COMMIT_ID "4637cb1eec48d1af8d23eeae1bb4c6f8de55eed9"
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/bbcoin/bips/blob/master/bip-0014.mediawiki)
 */
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bbcoin/bbcoin>";
