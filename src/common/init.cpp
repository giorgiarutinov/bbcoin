...
std::optional<ConfigError> InitConfig(ArgsManager& args, SettingsAbortFn settings_abort_fn)
{
    try {
        ...
        // bbcoin.conf file just ignores the other file.)
        ...
        if (!fs::exists(base_path)) {
            ...
            // in https://github.com/bbcoin/bbcoin/issues/16220 about ways to
        ...
        // Show an error or warn/log if there is a bbcoin.conf file in the
