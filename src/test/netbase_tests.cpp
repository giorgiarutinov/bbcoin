...
{
    BOOST_CHECK(TestSplitHost("www.bbcoincore.org", "www.bbcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.bbcoincore.org]", "www.bbcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.bbcoincore.org:80", "www.bbcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bbcoincore.org]:80", "www.bbcoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.bbcoincore.org:65536", "www.bbcoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.bbcoincore.org:0", "www.bbcoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.bbcoincore.org:", "www.bbcoincore.org:", 0, false));
}
