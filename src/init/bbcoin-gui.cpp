...
namespace init {
namespace {
const char* EXE_NAME = "bbcoin-gui";
...
public:
    ...
    // bbcoin-gui accepts -ipcbind option even though it does not use it
    // directly. It just returns true here to accept the option because
    // bbcoin-node accepts the option, and bbcoin-gui accepts all bbcoin-node
