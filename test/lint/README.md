...
```sh
DOCKER_BUILDKIT=1 docker build -t bbcoin-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/bbcoin -it bbcoin-linter
```
...
maintained:
* for `src/secp256k1`: https://github.com/bbcoin-core/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/bbcoin-core/leveldb-subtree.git (branch bbcoin-fork)
* for `src/crypto/ctaes`: https://github.com/bbcoin-core/ctaes.git (branch master)
* for `src/crc32c`: https://github.com/bbcoin-core/crc32c-subtree.git (branch bbcoin-fork)
* for `src/minisketch`: https://github.com/bbcoin-core/minisketch.git (branch master)

To do so, add the upstream repository as remote:

```
git remote add --fetch secp256k1 https://github.com/bbcoin-core/secp256k1.git
```
