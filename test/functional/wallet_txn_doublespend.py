...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 BBCO:
        ...
        # First: use raw transaction API to send 1240 BBCO to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 BBCO coin each
        ...
        # Node0's balance should be starting balance, plus 50BBCO for another
        ...
        # Node0's total balance should be starting balance, plus 100BBCO for
