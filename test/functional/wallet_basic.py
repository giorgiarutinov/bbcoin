...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BBCO from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 BBCO with subtract fee from amount
        ...
        # Sendmany 10 BBCO with subtract fee from amount
        ...
        # Sendmany 5 BBCO to two addresses with subtracting fee from both addresses
