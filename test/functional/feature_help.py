...
"""Verify that starting bbcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bbcoin with -h for help text")
        ...
        self.log.info("Start bbcoin with -version for version information")
        ...
        self.log.info("Start bbcoind with -fakearg to make sure it does not start")
